...
public class PrintServiceImpl implements PrintService {
	...
	@Override
	public List<Student> getStudentsandPartialResultsByLevelandUYandPer(int idLevel, int idUY, int idPer) {
		String queryStudent = "SELECT Etudiant.*, net_ecchoisis, 0 as cumulant, '' as ec_cumules, "
						...
						+ "WHERE Niveau_Etudiant.niv_id = "+idLevel+" AND Niveau_Etudiant.au_id = "+ idUY+" "
						+ "UNION "
						...
						+ "WHERE Parcours.niv_id = "+idLevel+" AND Etudiant_Cumule.au_id = "+idUY;
		System.out.print("\n "+queryStudent);
	...
	@Override
	public List<StudyUnit> getLevelStudyUnitandCourses(int idLevel) {
